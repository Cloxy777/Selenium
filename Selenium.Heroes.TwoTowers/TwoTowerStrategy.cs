...
public class TwoTowerStrategy : ITwoTowerStrategy
{
    public TwoTowerStrategy(PlayerManager playerManager, PlayerManager enemyManager, List<ICardDescriptor> cardDescriptors)
    {
    ...
    public CardWeight GetMostEffectiveCardDescriptor()
    {
        ...
        var cardWeights = calculator.GetCardWeights();
